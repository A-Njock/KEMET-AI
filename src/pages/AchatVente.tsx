  ...
  return (
    <div className="min-h-screen bg-ivory font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-40 pb-24 text-center">
        ...
        <h1 className="font-display text-5xl font-semibold text-navy mb-5">{t('achat_vente_title')}</h1>
        <p className="text-slate text-lg leading-relaxed">{t('achat_vente_text')}</p>
      </main>
      <Footer />
    </div>
  );
